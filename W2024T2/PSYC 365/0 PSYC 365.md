...
- Anterograde
	...
	- Appears to be able to acquire some procedural mem.

##### Episodic memory and the self
- *Autonoetic consciousness* (Tulving): "time travel": place selves in past or future or hypotheticals
- Key for explicit self awareness -- reflect on contents of episodic mem.

##### ***Take homes for Clive Wearing:***
- CW demonstrates dissc of mem systems
- Conscious, declarative episodic mem is gone
- Implicit procedural mem and strongest emotional assc, as well as semantic knowledge, spared
...
#### Reinstatement
- When brain helps consolidate a mem by playing *pattern of activation* that initially represented event *during encoding* later on
...
- Scripts based on info provided by life events & maintained in mem.
...
**RSA1: Regions involved in mem reinstatement**
- Whole brain analysis 
- What regions were most similar between rehearsal and reinstatement?

**RSA2 & 3: Higher similarity assc w greater mem vividness and detail**
...
Reinstatement of this rep helps consolidation by strengthening episodic details as well as more general semantic info, resulting in a mem that is resistant, but inflexible & semanticized

**Take homes**
- Mme reinstatement is key in consolidation
- Mem rehearsal allows reinstatement to contribute to mem detail in wakefulness & sleep 
...
Other explanations; 
- Rehearsal inhibits conosl of unrehers 
