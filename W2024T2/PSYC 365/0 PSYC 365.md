...
- *Encoding Approach*: Responses to object parts and then whole objects along moving along occipital cortex from EV to LOC • Encoding Approach: More invariant processing and more category specificity as we move along ventral stream. • Decoding approach: shows continuum of finer-grained categories. • In the ventral stream it matches semantic judgments of animal class • In LOC it is organized along a spectrum of inanimate (not like me!) to very animate (a lot like me!)
## Class 12 - 
