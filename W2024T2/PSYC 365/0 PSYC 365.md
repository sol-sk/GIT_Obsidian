...
- Crucial for navg.n: mental maps - link time & spacial roles
...
*Conundrum:*
- We know how rat space navg. works
...
- Had to navigate to a destination in response to customer requests 
	- During "drive," interruptions and changes to navg.
...
- Fernandez-Velasco & Spiers, 2024: Tradnl navg strategies are both local and insep from a *larger cultural system* 
- Interdisc approach: 
	- Phenomenology
	- Cogn ethnography
	- Brain imaging
