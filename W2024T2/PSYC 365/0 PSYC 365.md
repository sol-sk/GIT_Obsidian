...
memory bias: asked after a time what words they could remember from the list, measuring if they remembered more neg or pos words
...
- Selective attn 
	...
	- Motivated attn: emotional relevance and expectation of reward (DA) guide attn via amyg & BG mod
		- Patterns of attl bias linked to anxiety, depr., addict.n

### Memory 
Endel Tulving; multiple memory sys (not just short/long) '72
...
- Episodic memory & imagine future 
- Conscious memory in time sequence
...
"On the one hand we had lots of data for how the hippocampus works in spatial navigation in rats. For example in addition to place cells we now also know there are a number of 
**Other types of cells in hippocampus and medial temporal lobe that play a role in navigation:**
- *Grid cells*: entorhinal cortex (anterior temporal lobe, sends info → hipp) 
	 - Nonspecific: organize space into a gridlike map, used in any environment
	 - Hold constant
 - *Head direction cells, border cells* 
	 - Track the edges of a spatial location
> Recently researchers have begun to extend the idea of cognitive maps, first introduced in relation to rat spatial navigation, to episodic memory , or the ability to travel through time as well as space.

##### Cognitive map hypothesis
Brain builds rep/mental map of spatial env. to support memory and guide future act.n
...
#### Clive Wearing
- Every 2 minutes he "wakes up for the very first time": can perceive normally, but can *only* perceive: anything that is not in front of him no longer exists
- Began with fever; encephalitis which destroyed his hippocampus and parts of his frontal lobe 
- Has intense emotional responses (partially due to frontal lobe dmg)
- Still completely able to conduct, play music. 

**Affected brain regions**
- Hipp
- Temporal lobes
	- Medial on r, medial and lateral on L
- vPFC
- Fornix; connectivity btwn hipp & hypothal. regions 

##### **Summary: Wearing's Amnesia**
- Retrograde
	- No episodic
	- Some semantic 
	- Spared procedural 
- Anterograde
	- No encoding
	- Some slight encoding of new semantic info (learning that Deborah was driving from far away, becoming less surprised about her presence)
	- Appears to be able to acquire some procedural memory 

##### Episodic memory and the self
- *Autonoetic consciousness* (Tulving): "time travel": place selves in past or future or hypotheticals
- Key for explicit self awareness -- reflect on contents of episodic memory 

##### ***Take homes for Clive Wearing:***
- CW demonstrates dissc of memory systems
- Conscious, declarative episodic memory is gone
- Implicit procedural memory and strongest emotional assc, as well as semantic knowledge, spared
- Some behaviors don't fit clean distinction
- Intact semantic knowledge: retrieval sys are at least partly separate from episodic


> [!info] Learning Objectives
> - Describe the role of rehearsal and replay and in the consolidation of episodic memory 
> - Outline a major theory of the relationship between episodic memory , consolidation and semantic memory 
> -  Identify brain systems that play roles in autobiographical memory and reinstatement

#### Systems theories of Consolidation
*Review: Consolidation*
- Synaptic: short term, small scale
- Systems: long term, large scale
	- How: SCT, MTT

##### **Standard Consolidation Theory**
- Mems initially depend on hipp, later become consolidated elsewhere
- Recent mems vulnerable to hipp dmg, but older mems more durable
- Type of memory irrelevant
- Inspired by HM & temporally graded amnesia

##### **Multiple Trace Theory**
- Episodic → semantic: semanticization
	- Requires rehearsal
	- Multiple traces formed by multiple recalls
- Hipp creates episodic & traces → once traces formed → stored separately → hipp not required for retrieval 
	- CW could access semantic mems which originally formed from episodic, but not episodic mems 
	- CW difficult & slow to acquire new semantic mem
- Evidence: pt.s w/ preserved semantic but damaged episodic 

#### Reinstatement
- When brain helps consolidate a memory by playing *pattern of activation* that initially represented event *during encoding* later on
	- Reinstatement → semanticization (!important for Bird et al)

*Reading question: What is one way Bird et al. say that memory for complex events differs from memory for simple stimuli?*
- To comprehend the sequence of unfolding actions, it is necessary to interpret them with reference to our prior knowledge of similar situations, sometimes referred to as memory “schemas” or “scripts” . Therefore, memory for a complex lifelike event is never a straight- forward representation of the incoming information, but is instead a combination of this and our stored semantic knowledge.
#### Schema
- Mental concept that informs a person abt what to expect 
- Scripts based on info provided by life events & maintained in memory 
	- *in terms of predictive coding theory, schemas are frameworks that determine our dynamically changing forward models of the contents of perception.*

***Example video***

#### Bird et al
*Autobiographical variety network* 
- posterior cingulate, precuneus and retrosplenial cortex 

**Big Picture Question:** 
- What roles do active rehearsal and prior knowledge (schemas) play in episodic memory consolidation? 

**Research Questions:** 
- Does active rehearsal influence memory durability? 
- Do stronger patterns of neural similarity between encoding and rehearsal – reinstatement -- in episodic memory nodes lead to more detailed memory ?

**Two experiments**
1. Behavioral 
	1. Investigate effect of active rehearsal on *durability* of mem
2. fMRI 
	1. ID if BOLD activity reinstated when remembering unique videos
	2. Does strength of reinstatement when mems are being actively rehearsed predict how well the video will be remembered

**Experiment 1**
![[Screenshot 2025-03-24 at 2.25.51 PM.png|400]]

Participants: 13, w/in subj experiment 
IV: condition, day 
DV: quality of recall 

**Results**
![[Screenshot 2025-03-24 at 2.26.56 PM.png|400]]
- What details were remembered was consistent w/in participant (r .79) but not between (r .27)

**Experiment 2**
- Rehearsal cued 
- Better recall day 7 for videos rehearsed day 1
Participants: 16 
IVs: rehearsed or not
DVs: accuracy/vividness of recall 

*RSA*
- Encoding & rehearsal should have similar representational space for same clip (based on similarity of voxel patterns)
- Similarity of states; evaluate role of rehearsal

**RSA1: Regions involved in memory reinstatement**
- Whole brain analysis 
- What regions were most similar between rehearsal and reinstatement?

**RSA2 & 3: Higher similarity assc w greater memory vividness and detail**
- If lvl of vividness corrl w/ similarity in encoding/rehearsal pair: most relevant regions
> - For each subject, we calculated the difference between the weighted mean of the matching pairs and the unweighted mean of the matching pairs. If the degree of memory for a given video is unrelated to the similarity of the encoding-rehearsal pair, then the expected value of this contrast is zero. However, if the correlation between encoding-rehearsal pairs is in- creased when more details from that video are remembered, then the expected value of the contrast is greater than zero.

##### Summary so far
- Successful consolidation of video content depended on rehearsal shortly after encoding 
- Reinstatement of BOLD patterns in episodic memory nodes was associated with active rehearsal 
- Rehearsal: Does it speed up *semanticization* process as well as strengthen episodic memory ? 
- Findings consistent with integration of events into schema, which requires episodic + semantic info 
- *Posterior Cingulate Cortex*: Crucial role in active memory consolidation 
	- Integrates semantic and episodic information into a schema (was video like smth you've seen alr.?)


PCC integrating incoming episodic experience w/ existing knowledge to create a coherent rep of event? (schema)
Reinstatement of this rep helps consolidation by strengthening episodic details as well as more general semantic info, resulting in a memory that is resistant, but inflexible & semanticized

**Take homes**
- Memory reinstatement is key in consolidation
- Memory rehearsal allows reinstatement to contribute to memory detail in wakefulness & sleep 
	- Reactivating patterns of activity in hipp, MTL, PCC, that were active during encoding
- PCC plays key role in reinstatement vividness/detail

*Does this support semanticization?*

*Other explanations;* 
- Rehearsal inhibits consolidation of unrehearsed videos 
- Strengthening episodic rep (hippocampal) stabilizes mem
